#!/usr/bin/env bash
# ==============================================================================
# Purpose: Run5 Single End Data endmotif only
...
# How to run: bash 2_Fragmentomics_Scripts/Shell_scripts_to_generate_features_from_bams/1_Runner_scripts/Run5_Single_End_Data_endmotif_only.sh
