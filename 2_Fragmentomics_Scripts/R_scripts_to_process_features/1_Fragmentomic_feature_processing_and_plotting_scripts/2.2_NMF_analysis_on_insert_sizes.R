# ==============================================================================
# Purpose: 2 2 NMF analysis on insert sizes
...
# How to run: Rscript 2_Fragmentomics_Scripts/R_scripts_to_process_features/1_Fragmentomic_feature_processing_and_plotting_scripts/2.2_NMF_analysis_on_insert_sizes.R
...
# ==============================================================================
# ----------------------------------------------------------------------------
# Title   : NMF‑based Fragmentation Signature Analysis
# Authors : Dory Abelman, Althaf 
# Original date : 2023‑08‑16
# Updates:
#   • Oct–Nov 2023      – added new insert size datasets
#   • May 2024          – final prostate cancer revisions
#   • Dec 2024–Apr 2025 – manuscript resubmission edits
#
# Purpose :
#   1.   Load per‑sample insert‑size proportion matrices
#   2.   Annotate with TCGE_cfDM metadata (Dory & Althaf)
#   3.   Normalize mono‑nucleosomal fragment proportions
#   4.   Partition into training/testing sets for “Normal” vs “Cancer”
#   5.   Perform Non‑negative Matrix Factorization (NMF) to derive 2 signatures
#   6.   Extract W/H matrices and compute log₂ signature ratios
#   7.   Compare NMF signature ratio to Vessies reference fragmentation scores
#   8.   Calculate a patient‑level fragmentation score (FS) for all samples
#   9.   Generate line plots, boxplots, and combined figure layouts
#  10.   Save all intermediate RDS/CSV outputs for downstream ML pipelines
#
# ----------------------------------------------------------------------------
