# ==============================================================================
# Purpose: 9 1A Power analysis for revision
...
# How to run: Rscript 2_Fragmentomics_Scripts/R_scripts_to_process_features/3_Other_scripts_for_calculating_statistics/9.1A_Power_analysis_for_revision.R
...
cat("Number of PE DMRs:", nrow(norm_counts), "\n")
...
cat("Number of SE DMRs:", nrow(norm_counts_se), "\n")
