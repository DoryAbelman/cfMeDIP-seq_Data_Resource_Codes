# ==============================================================================
# Purpose: 1 2 Fragment proportions process and plot
...
# How to run: Rscript 2_Fragmentomics_Scripts/R_scripts_to_process_features/1_Fragmentomic_feature_processing_and_plotting_scripts/1.2_Fragment_proportions_process_and_plot.R
...
# Updated Dec 2024 - April 2025 for revision 
...
# Purpose : 
#   1. Load previously computed DELFI 5 Mb median fragment‑ratio R objects
#   2. Compute genome‑wide z‑scores (cancer vs. healthy)
#   3. Prepare and order data for ComplexHeatmap
#   4. Render and save heatmaps of fragmentation‑ratio z‑scores by chromosome arm
...
datasets <- "~/Documents/Thesis_work/R/M4/Projects/Fragmentation_CfMeDIP_Yong/Final Data Dec 2024/DELFI/Without validation - updated March 2025/"
outdir <- '~/Documents/Thesis_work/R/M4/Projects/Fragmentation_CfMeDIP_Yong/Final Data Dec 2024/DELFI/Without validation - updated March 2025/'
...
png(filename = file.path(outdir, "Heatmap_Z-score_DELFI_updated_in_cfMedip_5Mb_updated_legend_updated_colors_Dec_2024_new_colors_ordered_split_updated_3_narrow2.png"), 
...
saveRDS(plot_df, file = "DELFI_Ratios_updated_Dec2024.rds")
write.table(plot_df, file = "DELFI_Ratios_updated_Dec2024.txt", sep = "\t", quote = F, row.names = T)
...
saveRDS(pca_df, file = "DELFI_Ratios_updated_Dec2024_PCAs_90_percent_variance.rds")
saveRDS(pca_result, file = "PCA_result_Delfi_Dec2024.rds")
