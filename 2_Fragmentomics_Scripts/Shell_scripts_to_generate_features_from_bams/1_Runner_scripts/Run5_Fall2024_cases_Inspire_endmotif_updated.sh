#!/usr/bin/env bash
# ==============================================================================
# Purpose: Run5 Fall2024 cases Inspire endmotif updated
...
# How to run: bash 2_Fragmentomics_Scripts/Shell_scripts_to_generate_features_from_bams/1_Runner_scripts/Run5_Fall2024_cases_Inspire_endmotif_updated.sh
...
INPUTDIR=/cluster/projects/tcge/cell_free_epigenomics/processed_data/TCGE-CFMe-INSPIRE/dedup_bam_umi_pe
base=/cluster/projects/tcge/cell_free_epigenomics/processed_data/fragmentomics_dory/Run5_INSPIRE
outdir_delfi=$base/Output_Delfi
shdir=$base/sh_scripts_updated_endmotif
...
outdir_endmotif=$base/Output_Endmotif_All_Frags

insertsize=$base/Insert_size

slurm=$base/slurm_updated_endmotif
