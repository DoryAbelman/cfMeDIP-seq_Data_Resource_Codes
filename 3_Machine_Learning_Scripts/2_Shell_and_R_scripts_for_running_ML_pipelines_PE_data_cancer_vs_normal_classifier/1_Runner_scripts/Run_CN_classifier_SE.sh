...
# How to run: bash 3_Machine_Learning_Scripts/2_Shell_and_R_scripts_for_running_ML_pipelines_PE_data_cancer_vs_normal_classifier/1_Runner_scripts/Run_CN_classifier_SE.sh
...
# Paths
config_file="${CFMEDIP_CN_CONFIG:-/cluster/projects/tcge/cell_free_epigenomics/processed_data/fragmentomics_dory/Run2/Machine_Learning/January_2025/Machine_learning_config_combined_CN_classifier_Jan2025_SE.csv}"
output_dir="${CFMEDIP_CN_OUTPUT_DIR:-/cluster/projects/tcge/cell_free_epigenomics/processed_data/fragmentomics_dory/Run2/Machine_Learning/January_2025/output_scripts_CN_classifier_update_se}"
slurm_dir="${CFMEDIP_CN_SLURM_DIR:-/cluster/projects/tcge/cell_free_epigenomics/processed_data/fragmentomics_dory/Run2/Machine_Learning/January_2025/slurm_outputs_CN_classifier_update_se}"
